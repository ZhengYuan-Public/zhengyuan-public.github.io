---
title: Zheng's Proxmox Notes
date: 2023-07-31 12:00:00 -500
categories: [homelab, environment]
tags: [gpu-server]
---

**Installation Resources**: :cd:[Proxmox Images](https://proxmox.com/en/downloads), [Rufus](https://rufus.ie/en/)
...
​	[Disk Cache Mode (Proxmox Documentation)](https://pve.proxmox.com/wiki/Performance_Tweaks#Disk_Cache)
...
​	[VirtIO Driver for Windows](https://fedorapeople.org/groups/virt/virtio-win/direct-downloads/stable-virtio/virtio-win.iso)
